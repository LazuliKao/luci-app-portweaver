...
export default function (
    ...
    fs.read_direct(LOG_FILE, 'text')
      ...
      .catch((err: Error) => {
        if (err.toString().includes('NotFoundError')) {
          ...
          container.textContent = _('Error reading log: %s').format(err.toString());
        }
      });
  };
  ...
  o.render = function() {
    ...
    return E('div', { 'class': 'cbi-section' }, [
      E('div', { 'style': 'display: flex; gap: 10px; margin-bottom: 10px; align-items: center;' }, [
        E('button', {
        ...
        E('small', { 'style': 'color: #666; margin-left: auto;' }, 
