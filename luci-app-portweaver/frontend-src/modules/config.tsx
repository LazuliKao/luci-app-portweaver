...
export default function (
  ...
  } // Preview column
  {
    ...
    o.modalonly = false;
    o.formvalue = (section_id: string) => {
      const protocol = uci.get("portweaver", section_id, "protocol")?.toString() || "tcp";
      const family = uci.get("portweaver", section_id, "family")?.toString() || "any";
      const listen_port =
  ...
  // // Port mode switcher
  //const o = ss.option(form.Flag, "use_port_mappings", _("Use Port Mappings Mode"));
  // o.modalonly = true;
  // o.rmempty = true;
  // o.default = "0";
  // o.description = _(
  ...
  //const o = ss.option(form.Flag, "open_firewall_port", _("Open Firewall Port"));
  // o.modalonly = true;
  // o.default = "1";

  //const o = ss.option(form.Flag, "enable_app_forward", _("Enable App Level Forward"));
  // o.modalonly = true;
  // o.default = "0";
  //const o = ss.option(
  //   form.ListValue,
  ...
  //const o = ss.option(form.Flag, "add_firewall_forward", _("Add Firewall Forward"));
  // o.modalonly = true;
  // o.default = "1";
